...
for i=1002:1002
    ...
    %Iareaopen = 1- Iareaopen;
    figure,imshow(Iareaopen);
    line(rectx,recty);
    ...
    feature(j,:)=[HullArea,HullAreaRatio,HullPerimeter,leafArea,leafPerimeter,minBoundRectArea,minBoundRectPerimeter,PerimetertoArea,PerimetertoHull,rectlength,rectradio,rectwidth,SubAreaConvex,STATS.MajorAxisLength,STATS.MinorAxisLength,STATS.Eccentricity,STATS.EquivDiameter,STATS.Solidity,STATS.Extent,0];
...
newfeature = bsxfun(@rdivide,feature,std(feature));
